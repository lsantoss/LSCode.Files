...
namespace LSCode.Files.Directories
{
    ...
    public static class DirectoryHelper
    {
        ...
        public static DirectoryInfo Get(string path) => new DirectoryInfo(path);
        ...
        public static List<FileSystemInfo> GetContent(string path) => new DirectoryInfo(path).GetFileSystemInfos().OrderBy(x => x.Attributes).ThenBy(x => x.Name).ToList();
        ...
        public static List<DirectoryInfo> GetDirectories(string path) => new DirectoryInfo(path).GetDirectories().ToList();
        ...
        public static List<FileInfo> GetFiles(string path) => new DirectoryInfo(path).GetFiles().ToList();
        ...
        public static List<string> GetLogicalDrives() => Directory.GetLogicalDrives().ToList();
        ...
        public static void Move(string sourcePath, string destinationPath) => Directory.Move(sourcePath, destinationPath);
    }
}